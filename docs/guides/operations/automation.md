...
4. Confirm the README mutation job identified and awaited the explicitly dispatched Python, site, Docker, CodeQL, and Gitleaks runs on the pull-request head SHA. Do not bypass, re-label, or manually broaden the automation pull request to make auto-merge proceed.
